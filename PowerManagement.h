...
#if /* New board */ (HARDWARE_BOARD_REVISION == HARDWARE_ID_REV_PRODUCTION)
#define USB_RESET_BIT						(1 << USB_RESET)
#else /* Old boards */
...
#define BATTERY_PACK_DOUBLE_STANDARD_CURRENT	2640 // mA
#else /* New 8000 mAh Battery pack */
#define BATTERY_PACK_SINGLE_CAPACITY	8000 // mAh
#define BATTERY_PACK_DOUBLE_CAPACITY	16000 // mAh
#define BATTERY_PACK_SINGLE_STANDARD_CURRENT	1600 // mA
#define BATTERY_PACK_DOUBLE_STANDARD_CURRENT	3200 // mA
#endif

#define BATTERY_PACK_SINGLE_MAX_CONTINUOUS_CURRENT	3000 // mA
#define BATTERY_PACK_DOUBLE_MAX_CONTINUOUS_CURRENT	6000 // mA

#define BATTERY_VOLTAGE_THRESHOLD_HIGH	7300 // mV
#define BATTERY_VOLTAGE_THRESHOLD_LOW	5400 // mV

#define BATTERY_OPERATING_DISCHARGE_TEMP_HIGH	60 // Celsius
#define BATTERY_OPERATING_DISCHARGE_TEMP_LOW	(-20) // Celsius
#define BATTERY_OPERATING_CHARGE_TEMP_HIGH		45 // Celsius
#define BATTERY_OPERATING_CHARGE_TEMP_LOW		0 // Celsius

#define BATT_CHARGER_DEVICE_ADDRESS_SETTING					0X05
#define BATT_CHARGER_INPUT_MINIMUM_VOLTAGE_LIMIT_SETTING	0X06
#define BATT_CHARGER_SYSTEM_MINIMUM_VOLTAGE_SETTING			0x07
...
#define BATT_CHARGER_ADC_RESULT_OF_THE_SYSTEM_VOLTAGE		0x26
