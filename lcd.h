...
#define FT81X_BACKLIGHT_SUPER_LOW (FT81X_BACKLIGHT_MAX / 16) // 8
#define FT81X_BACKLIGHT_LOW (FT81X_BACKLIGHT_MAX / 8) // 16
#define FT81X_BACKLIGHT_DIM (FT81X_BACKLIGHT_MAX / 4) // 32
#define FT81X_BACKLIGHT_MID (FT81X_BACKLIGHT_MAX / 2) // 64
#define FT81X_BACKLIGHT_BRIGHT (FT81X_BACKLIGHT_MAX * 3 / 4) // 96
...
#define LCD_SPI_WIDTH_SINGLE	0x00
#define LCD_SPI_WIDTH_DUAL		0x01
#define LCD_SPI_WIDTH_QUAD		0x10
...
#define ROM_FONT       0x1e0000UL // Font table and bitmap, (Unverified), datasheet implies default is 0x201EE0
#define ROM_FONT_ADDR  0x2ffffcUL // Font table pointer address, Address range: 0x2FFFFC --> 0x2FFFFF, 4B (verified)
#define RAM_DL         0x300000UL // Display List RAM, Address range: 0x300000 --> 0x301FFF, 8KB (verified)
#define RAM_REG        0x302000UL // Registers, Address range: 0x302000 --> 0x302FFF, 4KB (verified)
#define RAM_CMD        0x308000UL // Command Buffer, Address range: 0x308000 --> 0x308FFF, 4KB, co-processor command circular buffer (verified)
