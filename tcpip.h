...
// WEB stack definitions
#define MYIP_1               192                 // our internet protocol (IP) address
#define ASCII_MYIP_1         "192"
#define MYIP_2               168
#define ASCII_MYIP_2         "168"
#define MYIP_3                 1
#define ASCII_MYIP_3         "1"
#define MYIP_4               150
#define ASCII_MYIP_4         "150"
...
#define MAX_TCP_TX_DATA_SIZE 256                 // max. outgoing TCP data size (even!)
...
unsigned int TCPSeqNr;                          // next sequence number to send
unsigned int TCPUNASeqNr;                       // last unaknowledged sequence number
                                                 // incremented AFTER sending data
unsigned int TCPAckNr;                          // next seq to receive and ack to send
...
unsigned short RecdFrameLength;                    // CS8900 reported frame length
...
//interrupt [TIMERA1_VECTOR] void TCPClockHandler(void);// interrupt function, called every 262 ms
